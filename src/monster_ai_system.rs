use specs::prelude::*;
use super::{Viewshed, Position, Paralyze, Map, Monster, WantsToMelee, RunState, SeenPlayer};
...
impl<'a> System<'a> for MonsterAI {
    ...
    fn run(&mut self, data : Self::SystemData) {
		...
		for (entity, mut viewshed, mut seenplayer, _monster, mut pos) in (&entities, &mut viewshed, &mut seenplayers, &monster, &mut position).join() {
